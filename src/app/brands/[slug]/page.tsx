  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="flex items-center gap-2 text-xs text-[#64748B] mb-8">
        ...
        <span>/</span>
        <Link href="/brands" className="hover:text-[#00D4FF] transition-colors">Brands</Link>
        <span>/</span>
        <span className="text-[#00D4FF]">{brand}</span>
      </div>

      {/* Brand Hero */}
      <div className="relative rounded-2xl overflow-hidden mb-10 p-8 border border-[#00D4FF]/10 bg-gradient-to-r from-[#00D4FF]/05 to-[#0D1117]">
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#00D4FF]/40 to-transparent" />
        <div className="flex items-center gap-5">
          <div className="w-20 h-20 rounded-2xl bg-[#0A0A0F]/80 border border-[#00D4FF]/25 flex items-center justify-center shadow-[0_0_24px_rgba(0,212,255,0.15)]">
            <span className="text-4xl font-black text-[#00D4FF]">{brand[0]}</span>
          </div>
          <div>
            <Badge className="mb-2 bg-[#00D4FF]/10 text-[#00D4FF] border border-[#00D4FF]/25 text-[10px]">
              {products.length} products
            </Badge>
            <h1 className="text-3xl font-black font-outfit text-white">{brand}</h1>
