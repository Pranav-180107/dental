...
export default function DealsPage() {
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
      {/* Hero */}
      <div className="relative rounded-2xl overflow-hidden mb-12 p-10 border border-[#00D4FF]/15 bg-gradient-to-r from-[#00D4FF]/08 via-[#0D1117] to-[#00B5A8]/08">
        ...
        <div className="flex items-center gap-3 mt-6">
          <Timer className="h-5 w-5 text-[#00D4FF]" />
          <span className="text-sm text-[#BAE6FD]">Deals reset every 24 hours</span>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-[#64748B] mt-1">{DEALS.length} deals available</p>
      </div>
